...
Shader "Custom/CustomRenderPass"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #if SHADER_API_GLES
                struct CustomRenderPassAttributes
                {
            ...
            struct CustomRenderPassVaryings
            {
                float2 uv : TEXCOORD0;
            ...
            CustomRenderPassVaryings vert(CustomRenderPassAttributes IN)
            {
                CustomRenderPassVaryings OUT;
                #if SHADER_API_GLES
            ...
            half4 frag(CustomRenderPassVaryings IN) : SV_Target
            {
